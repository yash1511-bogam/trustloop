...
# NOTE: EventBridge API Destinations require HTTPS endpoints.
# Add these back after setting up ACM certificate + custom domain on the ALB.
# The worker already handles billing automation internally via its polling loop.
