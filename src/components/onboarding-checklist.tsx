...
const steps = [
  ...
  { id: "hasSlack", label: "Connect Slack", desc: "Keep responders aligned with alerting and approved status updates.", href: "/settings/workspace#integrations", icon: SlackLogo },
  { id: "hasWebhook", label: "Set up a webhook integration", desc: "Accept incidents from Datadog, Sentry, PagerDuty, or custom sources.", href: "/settings/workspace#integrations", icon: Plug },
] as const;
