export default function DpaPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-20">
      <h1 className="mb-8 text-3xl font-bold text-slate-100">Data Processing Agreement</h1>
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-neutral-300">
        <section>
          <h2 className="text-xl font-semibold text-slate-200">1. Scope and Purpose</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">2. Data Processing Details</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">3. Processor Obligations</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">4. Sub-processors</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">5. Security Measures</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">6. Data Breach Notification</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">7. International Transfers</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">8. Contact</h2>
