  ...
  return (
    <main className="mx-auto max-w-3xl px-6 py-20">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-neutral-300">
        <section>
          <h2 className="text-xl font-semibold text-slate-200">1. Information We Collect</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">2. How We Use Your Information</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">3. Data Processing</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">4. Data Retention</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">5. Data Security</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">6. Your Rights</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-slate-200">7. Contact</h2>
